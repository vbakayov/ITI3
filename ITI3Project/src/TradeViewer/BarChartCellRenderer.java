...
// source:
// http://www.jroller.com/Thierry/resource/BarChartCode/BarChartCellRenderer.java
...
public class BarChartCellRenderer extends DefaultTableCellRenderer 
	...
	private static final Color[] COLORS = 
		new Color[] {new Color(89, 145, 236)};
	/**
	...
	public Component getTableCellRendererComponent(
		...
		int iRow,
		int iColumn) {
		setToolTipText(iTable.getValueAt(iRow, iColumn).toString());
