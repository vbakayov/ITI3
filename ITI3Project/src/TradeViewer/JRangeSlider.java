...
/*	The source code for this class slider is reused from
...
*
*	The changes from the original are only cosmetic - 
*	some of the colors have been altered
*	and the '3D' look has been disabled.
*/
...
{   
    ...
    protected Color thumbColor = new Color(89, 145, 236);
